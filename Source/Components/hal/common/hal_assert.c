...
void halAssertHazardLights(void)
{
  ...
  //HAL_TURN_OFF_LED1();//mine
  //HAL_TURN_OFF_LED2();//mine
  HAL_TURN_OFF_LED_NWK();//mine
  HAL_TURN_OFF_LED_Identify();//mine
...
#if (HAL_NUM_LEDS >= 1)
      //HAL_TOGGLE_LED1();//mine
#if (HAL_NUM_LEDS >= 2)
      //HAL_TOGGLE_LED2();//mine
#if (HAL_NUM_LEDS >= 3)
      HAL_TOGGLE_LED_NWK();//mine
#if (HAL_NUM_LEDS >= 4)
      HAL_TOGGLE_LED_Identify();//mine
#endif
#endif
#endif
#endif
   ...
   /* initialize for data dump loop */
    {
      ...
      while (iByte < DEBUG_DATA_SIZE)
      {
        ...
        //HAL_TURN_ON_LED1();//mine
        //HAL_TURN_ON_LED2();//mine
        HAL_TURN_ON_LED_NWK();//mine
        if (iBit == 0)
        {
          HAL_TURN_ON_LED_Identify();//mine
        }
        else
        {
          HAL_TURN_OFF_LED_Identify();//mine
