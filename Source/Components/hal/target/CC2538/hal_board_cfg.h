...
#define HAL_TURN_ON_LED_Identify()        GPIOPinWrite(BSP_LED_BASE, BSP_LED_2, BSP_LED_2)

#define HAL_TURN_OFF_LED_NWK()       GPIOPinWrite(BSP_LED_BASE, BSP_LED_1, 0)
#define HAL_TURN_OFF_LED_Identify()  GPIOPinWrite(BSP_LED_BASE, BSP_LED_2, 0)

/*-----------Relays-------------*/
//#define HAL_TURN_ON_RELAY1()         GPIOPinWrite(BSP_RELAY_BASE, BSP_RELAY_1, BSP_RELAY_1)      
//#define HAL_TURN_OFF_RELAY1()        GPIOPinWrite(BSP_RELAY_BASE, BSP_RELAY_1, 0) 
//
//#define HAL_TURN_ON_RELAY2()          GPIOPinWrite(BSP_RELAY_BASE, BSP_RELAY_2, BSP_RELAY_2)      
//#define HAL_TURN_OFF_RELAY2()         GPIOPinWrite(BSP_RELAY_BASE, BSP_RELAY_2, 0) 
/********************* end of mine ***************************/
...
#define HAL_TOGGLE_LED_Identify()    GPIOPinWrite(BSP_LED_BASE, BSP_LED_2, ~(GPIOPinRead(BSP_LED_BASE, BSP_LED_2)))
/*
#if defined (HAL_PA_LNA) || defined (HAL_PA_LNA_CC2592) || \
    defined (HAL_PA_LNA_CC2590) || defined (MAC_RUNTIME_CC2591) || \
    defined (MAC_RUNTIME_CC2592) || defined (MAC_RUNTIME_CC2590)
...
#define HAL_STATE_LED_Identify()     GPIOPinRead(BSP_LED_BASE, BSP_LED_2)
/*
#if defined (HAL_PA_LNA) || defined (HAL_PA_LNA_CC2592) || \
    defined (HAL_PA_LNA_CC2590) || defined (MAC_RUNTIME_CC2591) || \
    defined (MAC_RUNTIME_CC2592) || defined (MAC_RUNTIME_CC2590)
