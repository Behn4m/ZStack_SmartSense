...
void HalLedEnterSleep( void )
{
  ...
  HalSleepLedState = 0;
  //HalSleepLedState |= HAL_STATE_LED1();//mine
  //HalSleepLedState |= HAL_STATE_LED2() << 1;//mine
  HalSleepLedState |= HAL_STATE_LED_NWK() << 2;
  HalSleepLedState |= HAL_STATE_LED_Identify() << 3;
