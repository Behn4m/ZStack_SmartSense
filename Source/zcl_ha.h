...
#define ZCL_IS_DEVICEID_SOIL_HUMIDITY_SENSOR_DEVICE             0x0500
#define ZCL_IS_DEVICEID_RELATIVE_HUMIDITY_SENSOR_DEVICE         0x0501
#define ZCL_IS_DEVICEID_CURRENT_SENSOR_DEVICE                   0x0502  
